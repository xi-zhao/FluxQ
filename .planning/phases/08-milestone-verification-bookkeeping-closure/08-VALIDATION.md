...
- **Task-level smoke example (`08-05` proof-chain refresh):** `test -f .planning/phases/03-concurrent-workspace-safety/03-VERIFICATION.md && test -f .planning/phases/08-milestone-verification-bookkeeping-closure/08-VERIFICATION.md && rg -n "RUNT-02 \\| Phase 08 \\| Complete" .planning/REQUIREMENTS.md`
...
| 08-FLOW-02-E | 08-05 | 5 | RUNT-02 | T-08-05-01 / T-08-05-02 | The regenerated Phase 03 / Phase 08 verification artifacts and the reopened bookkeeping chain only re-close once the corrected alias-promotion proof is in place. | verification + ledger audit | `test -f .planning/phases/03-concurrent-workspace-safety/03-VERIFICATION.md && test -f .planning/phases/08-milestone-verification-bookkeeping-closure/08-VERIFICATION.md && rg -n "RUNT-02 \\| Phase 08 \\| Complete" .planning/REQUIREMENTS.md` | ✅ | ⬜ pending |
